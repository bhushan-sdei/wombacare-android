...
import com.app.womba.model.postResponseModel.Treatment
import com.app.womba.model.postResponseModel.TreatmentPost
import kotlinx.android.synthetic.main.item_conditons.view.*

class TreatmentAdapter (
    var context: Context,
    var mData: ArrayList<Treatment>,
    var mClick: HealthInterface
) : RecyclerView.Adapter<TreatmentAdapter.BindingHolder>() {
    ...
    override fun onBindViewHolder(holder: BindingHolder, position: Int) {
        holder.lblSpeciality.setText(mData[position].treatmentName)
